        ...
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-6 rounded-2xl text-white shadow-md">
                    ...
                    <button onClick={() => navigate('/exams/1/take')}
                    className="px-4 py-2 bg-white text-indigo-600 font-bold text-xs rounded-lg shadow cursor-pointer">VÀO PHÒNG THI</button>
                </div>
            </div>
        </div>
    );
