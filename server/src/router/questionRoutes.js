...
router.post('/create-single', authMiddleware, checkRole([1, 2]), questionController.createSingleQuestion);
router.post('/import-excel', authMiddleware, checkRole([1, 2]), questionController.importQuestionsFromExcel);
router.put('/:id', authMiddleware, checkRole([1, 2]), questionController.updateQuestion);
router.delete('/:id', authMiddleware, checkRole([1, 2]), questionController.deleteSingleQuestion);
